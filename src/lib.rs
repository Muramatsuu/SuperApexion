...
#[derive(Debug)]
pub struct SuperApexionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SuperApexionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SuperApexion processing");
    
    let mut processor = SuperApexionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SuperApexionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SuperApexionProcessor::new(false);
